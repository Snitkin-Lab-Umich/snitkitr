...
#                            keep_conf_only = TRUE,
#                            mat_suffix = "_R1_001.fastq.gz")
# # Couldnt' save because parser didn't work save(parsed_indel_cdif6, file = "data/cdif_indel_parsed6.RData")
#
...
#                            keep_conf_only = TRUE,
#                            mat_suffix = "_R1_001.fastq.gz")
# # Couldnt' save because parser didn't work save(parsed_indel_cdif7, file = "data/cdif_indel_parsed7.RData")
# #
