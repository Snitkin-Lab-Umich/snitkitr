...
test_that("New unified parser gives expected results for snp mat", {
  ...
  parsed_snp_cdif_test1d <-
    parse_snps(varmat_code = snitkitr::cdif_snp_code_mat,
                       varmat_allele = snitkitr::cdif_snp_allele_mat,
                       tree = NULL,
                       og = NULL,
                       remove_multi_annots = FALSE,
                       ...
                       mat_suffix = "_R1_001.fastq.gz",
                       ref_to_maj = TRUE)
  expect_identical(parsed_snp_cdif_test1c, parsed_snp_cdif_test1d)
...
test_that("New unified parser works at all on indel mat", {
  ...
  parsed_indel_cdif_testA2 <-
    parse_indels(varmat_code = snitkitr::cdif_indel_code_mat,
                       varmat_allele = snitkitr::cdif_indel_allele_mat,
                       tree = NULL,
                       og = NULL,
                       remove_multi_annots = TRUE,
                       ...
                       mat_suffix = "_R1_001.fastq.gz",
                       ref_to_maj = TRUE)
  expect_identical(parsed_indel_cdif_testA1, parsed_indel_cdif_testA2)
